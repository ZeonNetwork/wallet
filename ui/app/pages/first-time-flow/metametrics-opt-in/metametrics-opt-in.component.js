    ...
    return (
      <div className="metametrics-opt-in">
        <div className="metametrics-opt-in__main">
          ...
          <div className="metametrics-opt-in__title">Help Us Improve ZEON Wallet</div>
          <div className="metametrics-opt-in__body">
            <div className="metametrics-opt-in__description">
            ZEON Wallet would like to gather usage data to better understand how our users interact with the extension. This data
